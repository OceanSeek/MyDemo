...
����ֵ��  ��
�޸����ڣ�2019-11-22
1��δ����ĵ㲻���ͣ���nIndex=0��ID=0��ͻ��ң�Żᷢ�ͣ������Ĳ�����  
*****************************************************************/
...
/*****************************************************************
��������: CM104gx::GX104Master_Deal_RecvSSoe
��������: ��������SOE��� 
�������: 
����ֵ��  
�޸����ڣ�2019/09/29
	������дң�ű�־λ��������һ���߳�����дң��soe�����ݿ⣬����ʹ������ʽд���ݿ�
	ң�Ŵ洢��ң��ת�����У�RAM�����ٵ��߳��ж�ȡң��ת�����Ķ�״̬��δ����д��
	���ݿ⣬�����δ��״̬��
*****************************************************************/
...
//		return;
	...
	AINum = asdu->_num._num; //�ɱ�ṹ�޶���
	pData = asdu->_info;
	Type = asdu->_type;
	COT = asdu->_reason._reason;
	
	switch (Type){
		case IEC10X_M_ME_NA_1://0x09，归一化
			if ( asdu->_num._sq )//连续
			{	
				PRINT_FUNLINE;
				asdu->_num._sq ^= 1;
...
//					gpDevice[DevNO].pBurstAI[wBINo].flag = Flag_Spon;
			...
			break;
		case IEC10X_M_TI_BD_1://0x0B,标度化
			if ( asdu->_num._sq )//连续
			{	
				PRINT_FUNLINE;
				asdu->_num._sq ^= 1;
...
void GX104Master_Deal_RecvDZ(uint16_t DevNO,PGX104Master_DATA_T GX104MasterData)
{
	...
	switch (COT){
		case IEC10X_CALL_QOI_TOTAL://��Ӧ��ֵ�ٻ�
		case IEC10X_COT_SPONT://��ֵͻ��
			GX104Master_Deal_DZ_Call(DevNO, GX104MasterData);
			break;
		case IEC10X_COT_ACTCON://��ֵԤ�÷���
		case IEC10X_COT_REFUSE://��ֵԤ�þܾ�
...
//			gpDevice[DevNO].STATE_FLAG_INIT = ;
		...
		case IEC10X_TYPE_DZ_DATA://��ֵ��Ӧ�ٻ�
			GX104Master_Deal_RecvDZ(DevNO,GX104MasterData);
			gpDevice[DevNO].STATE_FLAG_DZCALLALL = GX104Master_FLAG_IDLE;
			break;
		case IEC10X_TYPE_DZ_JH://��ֵ����ȷ��
			break;
...
//					IEC10X_ClearQ();
	...
	switch (gpDevice[DevNO].STATE_FLAG_CALLALL){//���ٻ�
	...
	switch (gpDevice[DevNO].STATE_FLAG_DZCALLALL){//��ֵ�ٻ�
	...
	switch (gpDevice[DevNO].STATE_FLAG_CLOCK){//对时
...
/*****************************************************************
��������: GX104Master_On_Time_Out
��������: ��ʱ��Ӧ����,1����Ӧһ��
�������: 
	DevNO:�豸ID��
����ֵ��  ��
�޸����ڣ�2020-6-17
	ȥ������fd����Ϊ1����Ӧһ�Σ�10��һ�����٣�30��һ�ζ�ʱ
*****************************************************************/
int GX104Master_On_Time_Out(int DevNO){
